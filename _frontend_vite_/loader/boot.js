...
(async () => {
	...
	const cdnHost = 'https://fastly.jsdelivr.net/gh/truimo-dev/misskey-built@latest/_frontend_vite_'

	//#region Script
	async function importAppScript() {
		await import(CLIENT_ENTRY ? `${cdnHost}/${CLIENT_ENTRY.replace('scripts', lang)}` : '/vite/src/_boot_.ts')
			.catch(async e => {
				console.error(e);
